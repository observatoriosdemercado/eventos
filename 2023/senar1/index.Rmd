---
title: "CONTROLANDO CUSTOS PARA PRODUZIR MAIS."
...
### CONTROLAR CUSTOS PARA PRODUZIR MAIS OU PARA TER MAIS LUCROS?
...
.pull-left[
- Os economistas trabalham com curvas de custo. **Custo Variável Total**: parte do custo que varia com a produção. $CVT= f(Y)$ **Custo Fixo Total**: parte do custo que independe da produção. Ele existe mesmo com $Y=0$

- **Custo Total** é a soma dos custos. $CT=CVT + CFT$

- Em geral, além dos custos totais é normal se calcular os custos médios ou os custos por hectare. O **Custo Médio** ou **Custo Unitário** é dado por $CMe = CT/Y$. 
...
- A Oferta vai depender de que o preço pago seja maior do que o custo unitário/custo médio. A oferta continua existindo enquanto os preços pagarem os custos fixos e pelo menos uma parte dos custos variáveis. Ela para de existir quando os preços não pagarem os custos variáveis. 
...
---
class: center
### VAMOS DAR UMA OLHADA NOS CUSTOS DE UVA DE MESA...
...
knitr::include_graphics("imgs/img1.png")
```
...
---
class: center
### 99,5% DAS EXPORTAÇÕES DE UVA TEM ORIGEM NO VALE DO SÃO FRANCISCO, 13,3% DA PRODUÇÃO EM 2022.
...
knitr::include_graphics("img_r/img_ceagesp.png")
```
