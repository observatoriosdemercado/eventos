...
---
class: center
### ANÁLISE DA OFERTA DE UVA
```{r, echo=FALSE, out.width="86%"}
knitr::include_graphics("img_r/fig6_uva.png")
```
...
### ANÁLISE DA OFERTA DE UVA
```{r, echo=FALSE, out.width="86%"}
knitr::include_graphics("img_r/fig7_uva.png")
```
...
```{r, echo=FALSE, out.width="78%"}
knitr::include_graphics("img_r/fig6.png")
```
...
subclasse_positivos <-dados_04_vsf_positivos%>% filter(subclasse=="132600")
subclasse_negativos <-dados_04_vsf_negativos%>% filter(subclasse=="132600")
