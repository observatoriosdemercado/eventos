---
title: "MERCADO E COMERCIALIZAÇÃO DE MANGAS:"
subtitle: "CUSTOS E RENTABILIDADE."
author: 'João Ricardo Lima<br><span style = "font-size: 70%;">D.Sc em Economia Aplicada<br>joao.ricardo@embrapa.br'
date: "<span style = 'font-size: 70%;'> 22 de Outubro de 2022.</span>"
encoding: "UTF-8"
output:
...
- 2022 - 42 Boletins de Preços, 9 de Exportações de Manga, 8 de Geração de Empregos e 1 Consumo de Mangas.
...
```{r, out.width="12%"}
knitr::include_graphics("img_r/logo_mangatec.png")
```
