...
date: "<span style = 'font-size: 70%;'> 20 de Setembro de 2022.</span>"
output:
...
```{r, echo=FALSE}
knitr::include_app("https://bit.ly/3RSBxLI", height = "500px")
```

---
class: center
### INFORMAÇÕES CULTURA DA MANGA NA PAM/IBGE EM HTML

```{r, echo=FALSE}
knitr::include_app("https://bit.ly/3RUwcDE", height = "500px")
```
