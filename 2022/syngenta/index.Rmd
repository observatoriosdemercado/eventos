---
title: "MERCADO DE MANGA: TENDÊNCIAS E DESAFIOS"
...
- 2021 -  47 Boletins de Preços e 12 de Exportações Manga; 5 Boletins CEAGESP; 2 Boletins Informaçoes IBGE/PAM; 9 Boletins sobre Empregos;
- 2022 - 37 Boletins de Preços, 8 de Exportações de Manga, 7 de Geração de Empregos e 1 Consumo de Mangas.
...
```{r, echo=FALSE}
knitr::include_app("https://bit.ly/3L1nlxk", height = "500px")
```

---
class: center
### BOLETIM DO EMPREGO NA MANGA EM HTML

```{r, echo=FALSE}
knitr::include_app("https://bit.ly/3AtfXG9", height = "500px")
```
...
g1 <- dados %>% 
  ...
  labs(y= "Hectares", x= "Anos", title='Evolução da Área com Manga no Brasil: 2016-2020',
...
g3 <- ggplot(data=dadosp, aes(x=date)) +  #estetica vai valer para todos os geom's
  geom_line(aes(y=preco_def, colour="PREÇO"), lwd=0.8)+
