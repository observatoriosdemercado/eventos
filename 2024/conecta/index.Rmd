...
date: "<span style = 'font-size: 70%;'> 25 de Outubro de 2024.</span>"
encoding: "UTF-8"
output:
...
7) MODELOS DE PREVISÃO DE PREÇOS COM IA
...
today <- as.Date("2024-10-18") #data para o IGPI - ultima semana do preço
mes <- 9
...
g9 <- ggplot()+
  ...
  labs(y= "Preços R$", x= "Semanas do Ano", title='',
       caption = "Fonte: CEPEA reprocessado pelo Observatório de Mercado de Manga da Embrapa. Dados até a semana 42 de 2024.")+
  theme_minimal()+
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast1a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast2a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast3a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast4a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast5a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast6a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast7a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast8a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast9a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast10a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast11a.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("imgs/forecast12a.png")
```
