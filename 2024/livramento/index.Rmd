...
date: "<span style = 'font-size: 70%;'> Novembro de 2024.</span>"
encoding: "UTF-8"
output:
...
today <- as.Date("2024-11-22") #data para o IGPI - ultima semana do preço
mes <- 10
...
g9 <- ggplot()+
  ...
  labs(y= "Preços R$", x= "Semanas do Ano", title='',
       caption = "Fonte: CEPEA reprocessado pelo Observatório de Mercado de Manga da Embrapa. Dados até a semana 47 de 2024.")+
  theme_minimal()+
...
tail_means_livra <- tail(medias21_3_livra, 5)
